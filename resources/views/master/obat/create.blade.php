    ...
    <form action="{{ route('obat.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-5">
            <div>
                ...
                <input type="number" id="harga_dasar" name="harga_dasar" placeholder="0" value="{{ old('harga_dasar') }}" required
            ...
            <div>
                ...
                <input type="number" id="persen_untung" name="persen_untung" placeholder="0" value="{{ old('persen_untung') }}" required
