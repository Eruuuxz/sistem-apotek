...
<div class="bg-white p-6 shadow rounded w-full md:w-2/3">
    <form action="{{ route('obat.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="kode" class="border px-3 py-2 w-full @error('kode') border-red-500 @enderror" placeholder="Masukkan kode obat" value="{{ old('kode') }}" required>
            @error('kode')
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nama" class="border px-3 py-2 w-full @error('nama') border-red-500 @enderror" placeholder="Masukkan nama obat" value="{{ old('nama') }}" required>
            @error('nama')
                <p class="text-red-500 text-xs italic">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="number" name="stok" class="border px-3 py-2 w-full @error('stok') border-red-500 @enderror" placeholder="Jumlah stok tersedia" value="{{ old('stok') }}" required>
            @error('stok')
                <p class="text-red-500 text-xs italic">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="grid grid-cols-3 gap-4 mb-4">
            <div>
                ...
                <input type="number" id="harga_dasar" name="harga_dasar" class="border px-3 py-2 w-full @error('harga_dasar') border-red-500 @enderror" placeholder="0" oninput="hitungHargaJual()" value="{{ old('harga_dasar') }}" required>
                @error('harga_dasar')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                @enderror
            </div>
            <div>
                ...
                <input type="number" id="persen_untung" name="persen_untung" class="border px-3 py-2 w-full @error('persen_untung') border-red-500 @enderror" placeholder="0" oninput="hitungHargaJual()" value="{{ old('persen_untung') }}" required>
                @error('persen_untung')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                @enderror
            </div>
            <div>
                ...
                <input type="number" id="harga_jual" name="harga_jual" class="border px-3 py-2 w-full font-bold bg-gray-100 @error('harga_jual') border-red-500 @enderror" value="{{ old('harga_jual') }}" readonly required>
                @error('harga_jual')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                @enderror
            </div>
...
<script>
    ...
    // Panggil saat halaman dimuat untuk mengisi harga jual jika ada old input
