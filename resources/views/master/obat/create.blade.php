        ...
        <form action="{{ route('obat.store') }}" method="POST">
            ...
            <div class="mb-5">
                ...
                <select name="sediaan"
                    ...
                    <option value="Tetes Mata" {{ old('sediaan') == 'Tetes Mata' ? 'selected' : '' }}>Tetes Mata</option>
                    <option value="Tetes Telinga" {{ old('sediaan') == 'Tetes Telinga' ? 'selected' : '' }}>Tetes Telinga</option>
                    <option value="Suppositoria" {{ old('sediaan') == 'Suppositoria' ? 'selected' : '' }}>Suppositoria</option>
                    <option value="Suspensi" {{ old('sediaan') == 'Suspensi' ? 'selected' : '' }}>Suspensi</option>
                    <option value="Cream" {{ old('sediaan') == 'Cream' ? 'selected' : '' }}>Cream</option>
                    <option value="Gel" {{ old('sediaan') == 'Gel' ? 'selected' : '' }}>Gel</option>
                    <option value="Serbuk" {{ old('sediaan') == 'Serbuk' ? 'selected' : '' }}>Serbuk</option>
                    <option value="Lain-lain" {{ old('sediaan') == 'Lain-lain' ? 'selected' : '' }}>Lain-lain</option>
                </select>
                @error('sediaan')
                    <p class="text-red-500 text-xs mt-1 italic">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-5">
                ...
                <select name="kemasan_besar" id="kemasan_besar"
                    ...
                    <option value="Tube" {{ old('kemasan_besar') == 'Tube' ? 'selected' : '' }}>Tube</option>
                    <option value="Box" {{ old('kemasan_besar') == 'Box' ? 'selected' : '' }}>Box</option>
                    <option value="Dus" {{ old('kemasan_besar') == 'Dus' ? 'selected' : '' }}>Dus</option>
                    <option value="Pcs" {{ old('kemasan_besar') == 'Pcs' ? 'selected' : '' }}>Pcs</option>
                </select>
                @error('kemasan_besar')
                    <p class="text-red-500 text-xs mt-1 italic">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-5">
                ...
                <input type="text" name="satuan_terkecil" placeholder="Contoh: Tablet, Kapsul, ml" value="{{ old('satuan_terkecil') }}" required
            ...
            <div class="mb-5" id="rasio_konversi_group" style="display: none;">
                ...
                <input type="number" name="rasio_konversi" id="rasio_konversi" placeholder="Contoh: 10 (untuk 1 Strip = 10 Tablet)" value="{{ old('rasio_konversi', 1) }}" min="1"
