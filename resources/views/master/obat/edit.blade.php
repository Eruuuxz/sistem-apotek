...
<div class="bg-white p-8 shadow-xl rounded-xl max-w-2xl mx-auto mt-6">
    <form action="{{ route('obat.update', $obat->id) }}" method="POST">
        ...
        <div class="mb-5">
            ...
            <input type="text" name="kode" placeholder="Masukkan kode obat" value="{{ old('kode', $obat->kode) }}" required
        ...
        <div class="mb-5">
            ...
            <input type="text" name="nama" placeholder="Masukkan nama obat" value="{{ old('nama', $obat->nama) }}" required
        ...
        <div class="mb-5">
            ...
            <input type="number" name="stok" placeholder="Jumlah stok tersedia" value="{{ old('stok', $obat->stok) }}" required
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-5">
            <div>
                ...
                <input type="number" id="harga_dasar" name="harga_dasar" placeholder="0" value="{{ old('harga_dasar', $obat->harga_dasar) }}" required
            ...
            <div>
                ...
                <input type="number" id="persen_untung" name="persen_untung" placeholder="0" value="{{ old('persen_untung', $obat->persen_untung) }}" required
            ...
            <div>
                ...
                <input type="number" id="harga_jual" name="harga_jual" readonly value="{{ old('harga_jual', $obat->harga_jual) }}"
