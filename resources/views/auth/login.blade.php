...
<head>
    ...
    <title>Login Admin - Sistem Apotek</title>
...
<body class="bg-white">
    ...
    <div class="flex flex-wrap min-h-screen">
        ...
        <div class="hidden lg:flex w-1/2 items-center justify-center p-12 text-white bg-gradient-to-br from-blue-600 to-blue-800">
            <div class="w-full max-w-md text-center">
                ...
                <p class="text-blue-200">
                    Sistem manajemen apotek terpadu untuk mengelola bisnis Anda.
                </p>
            </div>
        </div>
