        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                <thead class="bg-gray-50 text-gray-600 uppercase">
                    <tr>
                        {{-- Index urutan sort disesuaikan setelah kolom Kemasan dihapus --}}
                        ...
                        {{-- Kolom Kemasan Dihapus --}}
                        <th class="px-4 py-3 text-right cursor-pointer" onclick="sortTable(2)">Stok</th>
    ...
    <script>
        ...
        function sortTable(colIndex) {
            ...
            rows.sort((a, b) => {
                ...
                // Numeric sort untuk Stok (index 2), HPP (4), Margin (5), Harga Jual (6)
                if ([2, 4, 5, 6].includes(colIndex)) {
