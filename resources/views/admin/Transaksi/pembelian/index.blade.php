                            ...
                            <tr class="hover:bg-gray-50 {{ $row->status == 'draft' ? 'bg-yellow-50/50' : '' }}">
                                ...
                                <td class="border px-4 py-2 text-center">
                                    <div class="flex items-center justify-center space-x-2">
                                        {{-- Tombol Edit / Lihat Faktur Internal --}}
                                        @if($row->status == 'draft')
                                        ...
                                        @else
                                            <a href="{{ route('pembelian.faktur', $row->id) }}" class="text-blue-600 hover:text-blue-900 inline-flex items-center text-sm" title="Lihat Faktur Internal">
                                        ...
                                        {{-- TOMBOL LIHAT BUKTI FAKTUR PBF (BARU) --}}
                                        @if($row->file_faktur)
                                            <a href="{{ Storage::url($row->file_faktur) }}" target="_blank" class="text-purple-600 hover:text-purple-900 inline-flex items-center text-sm" title="Lihat Foto Faktur PBF">
                                                 <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
