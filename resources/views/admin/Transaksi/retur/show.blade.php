    ...
    <div class="bg-white p-8 shadow-xl rounded-xl max-w-4xl mx-auto mt-6">
        ...
        <div class="flex justify-between items-start mb-6 pb-6 border-b">
            ...
            <div>
                ...
                @else
                    <span class="px-3 py-1 text-sm bg-green-100 text-green-800 rounded-full font-semibold">Retur
                        Penjualan</span>
                @endif
            </div>
        </div>
                ...
                <table class="w-full bg-white">
                    ...
                    <tfoot>
                        <tr class="bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-right font-bold text-xl text-blue-600">Rp
        ...
        <div class="mt-8 text-right flex justify-end gap-2">
            {{-- TOMBOL BARU --}}
            <a href="{{ route('retur.pdf', $retur->id) }}" target="_blank"
                class="bg-red-600 text-white px-6 py-2 rounded-lg hover:bg-red-700 font-semibold flex items-center">
            ...
            <a href="{{ route('retur.index') }}"
                class="bg-gray-200 text-gray-800 px-6 py-2 rounded-lg hover:bg-gray-300 font-semibold">Kembali</a>
        </div>
    </div>
@endsection