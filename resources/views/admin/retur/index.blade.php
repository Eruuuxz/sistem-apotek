                ...
                <tbody class="text-gray-700">
                    @forelse($data as $row)
                        <tr class="border-b border-gray-200 hover:bg-blue-50/50">
                            ...
                            <td class="px-4 py-3 text-right font-semibold text-blue-600">Rp {{ number_format($row->total, 0, ',', '.') }}</td>
                            <td class="px-4 py-3 text-center">
                                <a href="{{ route('retur.show', $row->id) }}" class="text-blue-600 hover:underline font-semibold">Lihat Detail</a>
                            </td>
                        </tr>
                    @empty
                         <tr>
                            <td colspan="5" class="text-center py-10 text-gray-500">
                                <div class="flex flex-col items-center">
                                    <svg class="w-12 h-12 text-gray-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 12h-15m0 0l6.75-6.75M4.5 12l6.75 6.75" /></svg>
