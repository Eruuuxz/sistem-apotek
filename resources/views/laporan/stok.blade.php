...
@section('content')
    ...
    <form method="GET" class="flex flex-wrap gap-2 mb-4 items-center bg-white p-4 rounded shadow">
        <input type="number" name="threshold" value="{{ $threshold }}" class="border px-3 py-2 rounded w-32"
        ...
        <a href="{{ route('laporan.stok') }}" class="px-4 py-2 rounded border hover:bg-gray-100 transition">Reset</a>
    </form>
