...
<div class="max-w-4xl mx-auto space-y-4">
    <h1 class="text-2xl font-bold">Tambah Retur</h1>
    ...
    <form action="{{ route('retur.store') }}" method="POST" class="bg-white shadow rounded p-6 space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
                ...
                <input type="text" name="no_retur" value="{{ $noRetur }}" class="w-full border rounded px-3 py-2 bg-gray-100" readonly>
            </div>
            <div>
        ...
        <div>
            ...
            <button type="button" id="add_item_btn" class="mt-2 bg-green-500 hover:bg-green-600 text-white px-3 py-1 rounded transition hidden">+ Tambah Item</button>
        </div>
        ...
        <div class="flex gap-2">
            <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded transition">Simpan Retur</button>
            <a href="{{ route('retur.index') }}" class="bg-gray-400 hover:bg-gray-500 text-white px-4 py-2 rounded transition">Batal</a>
        </div>
    </form>
</div>
@endsection
